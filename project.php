 ...
 <header class="margin" >
    ...
    <nav class="nav_bar">
      ...
      <a href="index.php">SignUp</a>
       <a href="help.html">Help</a>
        ...
        <?php if (isset($_SESSION['email']) && $_SESSION['email'] === 'kumkum@gmail.com') { ?>
  ...
  <div class="sidebar" >
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            <img src='uploads/{$row['image']}' alt = '{$row['name']}'>
             ...
             <p>Category: {$row['category']}</p>      
              <button style='width: 190px; height: 30px; cursor: pointer; font-weight: 660; background-color: #aeadadff;box-shadow: 0px 0px 1.7px 1px #9d9c9cff; color: black; border: none;' class='add-to-cart'          data-image='uploads/{$row['image']}' alt = '{$row['name']}'
          data-id='1'
          data-name='product'
    ...
    <div class="product-slider">
      ...
      <div class="products">
        <img onclick="alert(`purchased`)" src="assets/product_img.jpg" />
        <img onclick="alert(`purchased`)" src="assets/product1-1.jpg" />
        <img onclick="alert(`purchased`)" src="assets/product1-2.jpg" />
        <img onclick="alert(`purchased`)" src="assets/product1-3.jpg" />
        <img onclick="alert(`purchased`)" src="assets/product1-4.jpg" />
        <img onclick="alert(`purchased`)" src="assets/product1-5.jpg" />
        <img onclick="alert(`purchased`)" src="assets/product1-6.jpg" />
        <img onclick="alert(`purchased`)" src="assets/product1-7.jpg" />
        <img onclick="alert(`purchased`)" src="assets/product1-8.jpg" />
        <img onclick="alert(`purchased`)" src="assets/product1-9.jpg" />
        <img onclick="alert(`purchased`)" src="assets/product1-10.jpg" />
      </div>
    </div>
            ...
            <div class="Social_Network">
              ...
              <div>
                ...
                <div class="sizee">
                  ...
                  ></a>
                  <a style="color: #ff0000ff" href="https://x.com/?lang=en"
